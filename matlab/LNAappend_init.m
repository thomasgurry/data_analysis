...
function [yinit] = LNAappend_init(x,nspecies_subsystem,nparams_subsystem,nspecies_fullsystem,nparams_fullsystem)

% Add all equilibrated sub-system to full system initial conditions

[species,covmat] = LNAvect2mat(x,nspecies_subsystem,nparams_subsystem);
